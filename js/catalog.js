/* =========================================================================
   ...
   licença). Cobre peito e a maior parte dos outros grupos; alguns exercícios
   ficam sem foto por não ter correspondente identificado na fonte.
   ========================================================================= */
...
const EX = {
  ...
  remada_curvada:     {name:'Remada curvada barra', type:'reps', group:'costas', note:'Puxe com o cotovelo, tronco firme, sem balanço.', alts:['remada_cavalinho','remada_baixa'], img:true},
  remada_cavalinho:   {name:'Remada cavalinho apoiada', type:'reps', group:'costas', img:true},
  remada_baixa:       {name:'Remada baixa pegada neutra', type:'reps', group:'costas', img:true},
  remada_unilateral:  {name:'Remada unilateral halteres', type:'reps', group:'costas', img:true},
  puxada_pronada:     {name:'Puxada pegada pronada aberta', type:'reps', group:'costas', alts:['pulldown_neutro','barra_fixa'], img:true},
  pulldown_neutro:    {name:'Pulldown pegada neutra', type:'reps', group:'costas', img:true},
  barra_fixa:         {name:'Barra fixa ou puxada supinada', type:'reps', group:'costas', note:'Dor no ombro: troque por remada baixa neutra.', alts:['remada_baixa','pulldown_neutro'], img:true},

  desenv_militar:     {name:'Desenvolvimento militar em pé', type:'reps', group:'ombro', alts:['desenv_halteres'], img:true},
  desenv_halteres:    {name:'Desenvolvimento halteres sentado', type:'reps', group:'ombro', alts:['desenv_militar'], img:true},
  elevacao_lateral:   {name:'Elevação lateral', type:'reps', group:'ombro', img:true},
  face_pull:          {name:'Face pull na polia', type:'reps', group:'ombro', img:true},

  rosca_direta:       {name:'Rosca direta barra reta', type:'reps', group:'bíceps', alts:['rosca_alternada','rosca_scott'], img:true},
  rosca_alternada:    {name:'Rosca alternada halteres', type:'reps', group:'bíceps', img:true},
  rosca_martelo:      {name:'Rosca martelo', type:'reps', group:'bíceps', img:true},
  rosca_scott:        {name:'Rosca scott', type:'reps', group:'bíceps', img:true},
  triceps_corda:      {name:'Tríceps corda na polia', type:'reps', group:'tríceps', alts:['triceps_testa'], img:true},
  triceps_testa:      {name:'Tríceps testa', type:'reps', group:'tríceps', alts:['triceps_corda'], img:true},
  triceps_mergulho:   {name:'Mergulho no banco ou paralelas', type:'reps', group:'tríceps', img:true},

  fecho_pegada:       {name:'Fecho de pegada na barra fixa', type:'time', group:'pegada', note:'Trabalho direto de pegada e antebraço. Segure a barra o máximo que aguentar, sem balançar.', img:true},
  farmer:             {name:'Farmer carry', type:'dist', group:'pegada', note:'Pegada firme, ombro para trás, passo curto.', img:true},

  agachamento:        {name:'Agachamento livre barra', type:'reps', group:'quadríceps', note:'Quadril e joelho descem juntos, joelho segue a direção do pé. Dor no joelho: troque por Smith ou leg press com pés mais altos.', alts:['agach_smith','leg_press','hack'], img:true},
  agach_smith:        {name:'Agachamento no Smith', type:'reps', group:'quadríceps', img:true},
  agach_frontal:      {name:'Agachamento frontal ou hack machine', type:'reps', group:'quadríceps', alts:['hack','agach_smith'], img:true},
  hack:               {name:'Hack machine', type:'reps', group:'quadríceps', img:true},
  leg_press:          {name:'Leg press 45 graus', type:'reps', group:'quadríceps', alts:['leg_press_alto','hack'], img:true},
  leg_press_alto:     {name:'Leg press pés altos', type:'reps', group:'quadríceps', img:true},
  extensora:          {name:'Cadeira extensora', type:'reps', group:'quadríceps', img:true},
  bulgaro:            {name:'Afundo búlgaro halteres', type:'reps', group:'quadríceps', alts:['leg_press','passada'], img:true},
  passada:            {name:'Passada com halteres', type:'reps', group:'quadríceps', img:true},

  terra_romeno:       {name:'Levantamento terra romeno', type:'reps', group:'posterior', note:'Quadril vai para trás primeiro, barra roça a perna, coluna neutra. Dor lombar: troque por cadeira flexora e glúteo na polia baixa.', alts:['stiff','flexora','gluteo_polia'], img:true},
  stiff:              {name:'Stiff halteres', type:'reps', group:'posterior', img:true},
  flexora:            {name:'Cadeira flexora', type:'reps', group:'posterior', img:true},
  gluteo_polia:       {name:'Glúteo na polia baixa', type:'reps', group:'posterior', img:true},
  hip_thrust:         {name:'Hip thrust barra', type:'reps', group:'posterior', alts:['gluteo_polia'], img:true},

  panturrilha_pe:     {name:'Panturrilha em pé', type:'reps', group:'panturrilha', alts:['panturrilha_sent'], img:true},
  panturrilha_sent:   {name:'Panturrilha sentado', type:'reps', group:'panturrilha', alts:['panturrilha_pe'], img:true},

  prancha:            {name:'Prancha abdominal', type:'time', group:'core', img:true},
  prancha_lateral:    {name:'Prancha lateral', type:'time', group:'core', img:true},
  abdominal_polia:    {name:'Abdominal na polia', type:'reps', group:'core', img:true},

  esteira_inclinada:  {name:'Esteira caminhada inclinada', type:'cardio', group:'cardio', img:true},
  esteira_corrida:    {name:'Esteira corrida', type:'cardio', group:'cardio', img:true},
  bike_ergometrica:   {name:'Bicicleta ergométrica', type:'cardio', group:'cardio', img:true},
  eliptico:           {name:'Elíptico', type:'cardio', group:'cardio', img:true},
  remo_ergometro:     {name:'Remo ergômetro', type:'cardio', group:'cardio', img:true},
  escada_ergometrica: {name:'Escada ergométrica', type:'cardio', group:'cardio', img:true},
  ...
  pullover:                {name:'Pullover halteres', type:'reps', group:'costas', img:true},
  ...
  desenvolvimento_arnold:  {name:'Desenvolvimento Arnold', type:'reps', group:'ombro', img:true},
  elevacao_frontal:        {name:'Elevação frontal', type:'reps', group:'ombro', img:true},
  crucifixo_inverso:       {name:'Crucifixo inverso', type:'reps', group:'ombro', img:true},
  remada_alta:             {name:'Remada alta barra', type:'reps', group:'ombro', img:true},
  remada_alta_halteres:    {name:'Remada alta com halteres', type:'reps', group:'ombro', img:true},
  desenv_halteres_unilateral: {name:'Desenvolvimento unilateral com halteres', type:'reps', group:'ombro', img:true},
  elevacao_lateral_unilateral: {name:'Elevação lateral unilateral', type:'reps', group:'ombro', img:true},
  elevacao_frontal_unilateral: {name:'Elevação frontal unilateral', type:'reps', group:'ombro', img:true},
  desenvolvimento_maquina: {name:'Desenvolvimento de ombro na máquina', type:'reps', group:'ombro', img:true},

  remada_serrote:          {name:'Remada serrote', type:'reps', group:'costas', img:true},
  remada_t:                {name:'Remada T', type:'reps', group:'costas', img:true},
  encolhimento_trapezio:   {name:'Encolhimento de trapézio', type:'reps', group:'costas', img:true},
  remada_baixa_unilateral: {name:'Remada baixa unilateral na polia', type:'reps', group:'costas', img:true},
  remada_maquina_unilateral: {name:'Remada unilateral na máquina', type:'reps', group:'costas', img:true},
  puxada_unilateral:       {name:'Puxada unilateral na polia', type:'reps', group:'costas', img:true},
  remada_barra_supinada:   {name:'Remada curvada pegada supinada', type:'reps', group:'costas', img:true},

  rosca_concentrada:       {name:'Rosca concentrada', type:'reps', group:'bíceps', img:true},
  rosca_inversa:           {name:'Rosca inversa barra', type:'reps', group:'bíceps', img:true},
  rosca_21:                {name:'Rosca 21', type:'reps', group:'bíceps', img:true},
  rosca_punho:             {name:'Rosca de punho', type:'reps', group:'bíceps', img:true},
  rosca_unilateral_halteres: {name:'Rosca direta unilateral com halter', type:'reps', group:'bíceps', img:true},
  rosca_martelo_unilateral: {name:'Rosca martelo unilateral', type:'reps', group:'bíceps', img:true},
  ...
  triceps_corda_unilateral: {name:'Tríceps corda unilateral', type:'reps', group:'tríceps', img:true},
  triceps_frances_unilateral: {name:'Tríceps francês unilateral', type:'reps', group:'tríceps', img:true},
  triceps_testa_unilateral: {name:'Tríceps testa unilateral', type:'reps', group:'tríceps', img:true},
  triceps_coice:           {name:'Tríceps coice halteres', type:'reps', group:'tríceps', img:true},

  agachamento_sumo:        {name:'Agachamento sumô', type:'reps', group:'quadríceps', img:true},
  leg_press_unilateral:    {name:'Leg press unilateral', type:'reps', group:'quadríceps', img:true},
  cadeira_adutora:         {name:'Cadeira adutora', type:'reps', group:'quadríceps', img:true},
  cadeira_abdutora:        {name:'Cadeira abdutora', type:'reps', group:'posterior', img:true},
  panturrilha_leg_press:   {name:'Panturrilha no leg press', type:'reps', group:'panturrilha', img:true},
  terra_convencional:      {name:'Levantamento terra convencional', type:'reps', group:'posterior', img:true},
  terra_sumo:              {name:'Levantamento terra sumô', type:'reps', group:'posterior', img:true},
  ...
  afundo_halteres_caminhando: {name:'Afundo caminhando com halteres', type:'reps', group:'quadríceps', img:true},
  bulgaro_smith:           {name:'Agachamento búlgaro no Smith', type:'reps', group:'quadríceps'},
  agachamento_taca:        {name:'Agachamento taça', type:'reps', group:'quadríceps', img:true},
  step_up:                 {name:'Step up com halteres', type:'reps', group:'quadríceps', img:true},
  afundo_reverso:          {name:'Afundo reverso peso corporal', type:'reps', group:'quadríceps', img:true},
  good_morning_barra:      {name:'Good morning com barra', type:'reps', group:'posterior', img:true},
  gluteo_4_apoios:         {name:'Glúteo em 4 apoios', type:'reps', group:'posterior', img:true},
  gluteo_caneleira:        {name:'Glúteo com caneleira', type:'reps', group:'posterior', img:true},
  panturrilha_unilateral_corpo: {name:'Panturrilha unilateral peso corporal', type:'reps', group:'panturrilha'},
  panturrilha_smith:       {name:'Panturrilha no Smith', type:'reps', group:'panturrilha', img:true},
  panturrilha_burro:       {name:'Panturrilha burro', type:'reps', group:'panturrilha', img:true},

  abdominal_infra:         {name:'Abdominal infra', type:'reps', group:'core', img:true},
  elevacao_pernas_suspenso: {name:'Elevação de pernas suspenso', type:'reps', group:'core', img:true},
  roda_abdominal:          {name:'Roda abdominal', type:'reps', group:'core'},
  prancha_elevacao_membro: {name:'Prancha com elevação de membro', type:'time', group:'core', img:true},
  abdominal_bicicleta:     {name:'Abdominal bicicleta', type:'reps', group:'core', img:true},
  abdominal_canivete:      {name:'Abdominal canivete', type:'reps', group:'core', img:true},
  prancha_dinamica:        {name:'Prancha dinâmica', type:'time', group:'core', img:true},
  russian_twist:           {name:'Abdominal russo', type:'reps', group:'core', img:true},
  superman:                {name:'Superman', type:'reps', group:'core', img:true},
  hiperextensao_banco:     {name:'Hiperextensão no banco romano', type:'reps', group:'core', img:true},
  abdominal_maquina:       {name:'Abdominal na máquina', type:'reps', group:'core', img:true},

  farmer_unilateral:       {name:'Farmer carry unilateral', type:'dist', group:'pegada', img:true}
};
...
const EX_EXTRA = {
  ...
  desenv_elastico:    {name:'Desenvolvimento com elástico', type:'reps', group:'ombro', img:true},
  ...
  remada_halteres:    {name:'Remada curvada com halteres', type:'reps', group:'costas', img:true},
  remada_invertida:   {name:'Remada invertida', type:'reps', group:'costas', note:'Use uma barra baixa, mesa firme ou o corrimão. Quanto mais deitado, mais difícil.', img:true},
  ...
  lateral_elastico:   {name:'Elevação lateral com elástico', type:'reps', group:'ombro', img:true},
  rosca_elastico:     {name:'Rosca com elástico', type:'reps', group:'bíceps'},
  triceps_elastico:   {name:'Tríceps com elástico', type:'reps', group:'tríceps', img:true},
  flexao_diamante:    {name:'Flexão diamante', type:'reps', group:'tríceps'},
  agach_corpo:        {name:'Agachamento peso corporal', type:'reps', group:'quadríceps', img:true},
  afundo_corpo:       {name:'Afundo peso corporal', type:'reps', group:'quadríceps', img:true},
  agach_bulgaro_corpo:{name:'Agachamento búlgaro peso corporal', type:'reps', group:'quadríceps'},
  ponte_gluteo:       {name:'Ponte de glúteo', type:'reps', group:'posterior', img:true},
  elevacao_pelvica:   {name:'Elevação pélvica apoiada no banco', type:'reps', group:'posterior', img:true},
  good_morning_elast: {name:'Good morning com elástico', type:'reps', group:'posterior', img:true},
  ...
  panturrilha_halter: {name:'Panturrilha em pé com halteres', type:'reps', group:'panturrilha', img:true},
  abdominal_solo:     {name:'Abdominal no solo', type:'reps', group:'core', img:true},
